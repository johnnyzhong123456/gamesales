...
public class GameSaleServiceImpl implements GameSaleService {
	...
	private static final Logger logger = LoggerFactory.getLogger(GameSaleServiceImpl.class);
...
//     @Index(name = "idx_date_game", columnList = "dateOfSale, gameNo")
	 ...
	 * 1. add orindry & composite index based on frequently query column
	 * 2. add caching ( redis & in-memory caching ConcurrentMapCache ) 
	 * 3. QueryOptimization (not select * , ... )
	 */
